...
pub(super) async fn run_subagent_once(
    ...
    let pump = SubagentEventPump::spawn(
        ...
        SubagentEventPumpConfig {
            ...
            telemetry_identity: parent_task_run_id.clone().zip(subtask_run_id.clone()),
            telemetry_call_label: call_label.clone(),
    ...
    let mut provider_connected_rx = pump.provider_connected_rx;
    let mut first_response_rx = pump.first_response_rx;
