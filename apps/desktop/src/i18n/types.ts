...
export interface TranslationKeys {
  ...
  'settings.toolAccessOverviewTitle': string;
  'settings.toolAccessOverviewDesc': string;
  'settings.toolAccessOverviewNoTools': string;
  'settings.toolAccessRead': string;
  'settings.toolAccessWrite': string;
  'settings.toolAccessExecute': string;
  'settings.toolAccessNetwork': string;
  'settings.toolAccessNeedsApproval': string;
  'settings.toolAccessNoApproval': string;
  'settings.toolRiskLow': string;
  'settings.toolRiskMedium': string;
  'settings.toolRiskHigh': string;
  ...
  'chat.workPlanLabel': string;
  'chat.workPlanReviewRequired': string;
  'chat.workPlanReviewOptional': string;
  'chat.workPlanTargetCount': string;
  'chat.workPlanStagePlanner': string;
  'chat.workPlanStageExecutor': string;
  'chat.workPlanStageReviewer': string;
  'chat.workPlanRiskLow': string;
  'chat.workPlanRiskMedium': string;
  'chat.workPlanRiskHigh': string;
  'chat.contextManifestLabel': string;
  'chat.contextManifestSummary': string;
  'chat.contextManifestRoleInstruction': string;
  'chat.contextManifestRoleEvidence': string;
  'chat.contextManifestRoleToolGuidance': string;
  'chat.contextManifestRoleMemory': string;
  'chat.contextManifestRoleConversation': string;
  'chat.contextManifestRoleSourceScope': string;
  'chat.contextManifestTrustSystem': string;
  'chat.contextManifestTrustUserSelected': string;
  'chat.contextManifestTrustRetrievedEvidence': string;
  'chat.contextManifestTrustAgentMemory': string;
  'chat.contextManifestTrustExternal': string;
  'chat.trustAuthorityObservation': string;
  'chat.trustVisibilitySourceScope': string;
  'chat.trustVisibilityWorkspace': string;
  'chat.trustVisibilityCurrentChat': string;
  'chat.trustCanInstruct': string;
  'chat.trustCanInstructYes': string;
  'chat.trustCanInstructNo': string;
  'chat.generatedImageAlt': string;
  'chat.diffFiles': string;
  'chat.diffReplacements': string;
  'chat.diffPending': string;
  'chat.diffHunks': string;
  'chat.toolBriefError': string;
  'chat.toolBriefDeclined': string;
  'chat.toolBriefCancelled': string;
  'chat.toolBriefLines': string;
  'chat.toolBriefDone': string;
  'chat.capabilityReadOnly': string;
  'chat.capabilityWrites': string;
  'chat.capabilityParallel': string;
  'chat.capabilitySerial': string;
  'chat.capabilityCancellable': string;
  'chat.capabilityBlocking': string;
  'chat.capabilityResources': string;
  'chat.subagentParallelRun': string;
  'chat.subagentParallelCount': string;
  'chat.subagentCompletedCount': string;
  'chat.subagentFailedCount': string;
  'chat.subagentJudgementFallback': string;
  'chat.subagentConfidence': string;
  'chat.subagentWinners': string;
  'chat.subagentRubric': string;
  ...
  'settings.projectTools.title': string;
  'settings.projectTools.description': string;
  'settings.projectTools.openManifest': string;
  'settings.projectTools.showFolder': string;
  'settings.projectTools.tools': string;
  'settings.projectTools.runnable': string;
  'settings.projectTools.issues': string;
  'settings.projectTools.noTools': string;
  'settings.projectTools.manifestDirs': string;
  'settings.projectTools.command': string;
  'settings.projectTools.parameters': string;
  'settings.projectTools.noParameters': string;
  'settings.projectTools.sourceRoot': string;
  'settings.projectTools.manifestPath': string;
  'settings.projectTools.manifestHash': string;
  'settings.projectTools.invalidManifests': string;
  'settings.projectTools.invalidManifestsDesc': string;
  'settings.projectTools.reads': string;
  'settings.projectTools.writes': string;
  'settings.projectTools.executes': string;
  'settings.projectTools.network': string;
  'settings.projectTools.metadataOnly': string;
  'settings.projectTools.warnings': string;
  'settings.projectTools.metadataWarning': string;
  'settings.projectTools.writeWarning': string;
  'settings.projectTools.networkWarning': string;
  'settings.projectTools.openPathError': string;
  'settings.projectTools.loadError': string;
